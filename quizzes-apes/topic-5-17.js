...
// Registered in quizzes-apes/index.js as "apes-topic-5-17".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-17-5",
    question: "Prescribed burning is used in forest management to",
    options: [
      "reduce fuel buildup and lower severe fire risk",
      "increase the total amount of dead fuel present",
      "prevent any natural regeneration from occurring",
      "eliminate all trees from a designated area"
    ],
    correctIndex: 0,
    explanation: "Decades of fire suppression allowed dangerous fuel accumulation in many forests. Controlled low-intensity burns also stimulate fire-adapted species."
  },
  {
    id: "5-17-6",
  ...
  {
    id: "5-17-7",
    question: "Forests contribute to climate mitigation primarily by",
    options: [
      "preventing any precipitation from reaching soil",
      "releasing stored carbon into the atmosphere",
      "sequestering carbon in biomass and soil",
      "increasing the albedo of the land surface"
    ],
    correctIndex: 2,
    explanation: "Growing trees pull CO₂ from the air and store it in wood and soil. Protecting existing mature forest generally stores more carbon than new planting."
  },
  {
    id: "5-17-8",
    question: "A concern with tree plantations replacing natural forest is that plantations",
    options: [
      "store substantially more carbon than natural forest",
      "require no management once they are established",
      "support the same biodiversity as natural forest",
      "are typically monocultures with far less biodiversity"
    ],
    correctIndex: 3,
    explanation: "Even-aged single-species stands lack the structure natural forests provide. Counting plantations as restored forest overstates ecological recovery."
  },
  {
    id: "5-17-9",
