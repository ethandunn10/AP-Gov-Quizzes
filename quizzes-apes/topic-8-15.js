...
// Registered in quizzes-apes/index.js as "apes-topic-8-15".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "8-15-2",
    question: "Cholera is transmitted primarily through",
    options: [
      "the bite of an infected mosquito vector",
      "water contaminated with infected fecal matter",
      "airborne droplets released when a person coughs",
      "direct contact with contaminated soil surfaces"
    ],
    correctIndex: 1,
    explanation: "John Snow's 1854 investigation of a London outbreak founded modern epidemiology. Clean water and sanitation are the definitive preventions."
  },
  {
    id: "8-15-3",
  ...
  {
    id: "8-15-4",
    question: "Climate change is expected to affect infectious disease patterns by",
    options: [
      "having no measurable effect on disease distribution",
      "confining all diseases to their current geographic range",
      "eliminating vector borne diseases from all regions",
      "expanding the range of disease carrying vectors"
    ],
    correctIndex: 3,
    explanation: "Warmer temperatures let mosquitoes survive at higher latitudes and elevations. Dengue and malaria ranges are both projected to shift."
  },
  {
    id: "8-15-5",
  ...
  {
    id: "8-15-10",
    question: "Emerging infectious diseases are increasing in frequency partly because of",
    options: [
      "declining global travel and reduced trade between nations",
      "urbanization, global travel, and land use change",
      "improvements in sanitation across developing countries",
      "the complete elimination of all wildlife habitat"
    ],
    correctIndex: 1,
    explanation: "Dense populations, rapid travel, and wildlife contact create ideal conditions for spillover and spread. Surveillance and rapid response are the main defenses."
  }
];
