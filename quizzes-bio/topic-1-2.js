// quizzes-bio/topic-1-2.js
// Unit 1: Chemistry of Life — Topic 1.2: Elements of Life
// Registered in quizzes-bio/index.js as "bio-topic-1-2".
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "1.2-8",
    question: "Calcium is an essential element in the human body primarily because it is required for:",
    options: ["Hemoglobin structure and oxygen transport", "Bone structure, muscle and nerve signaling", "Synthesis of thyroid hormone in the neck", "Base pairing in the DNA double helix"],
    correctIndex: 1,
    explanation: "Calcium ions are critical for bone/tooth mineralization, triggering muscle contraction, and facilitating neurotransmitter release at synapses."
  },
  {
    id: "1.2-9",
