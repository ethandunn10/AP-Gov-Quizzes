// quizzes-bio/topic-2-2.js
// Unit 2: Cell Structure and Function — Topic 2.2: Cell Size
// Registered in quizzes-bio/index.js as "bio-topic-2-2".
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "2.2-5",
    question: "If a spherical cell's radius doubles, its surface area increases by a factor of 4, but its volume increases by a factor of:",
    options: ["2", "4", "8", "16"],
    correctIndex: 2,
    explanation: "Surface area scales with r^2 (doubling r gives 4x area) while volume scales with r^3 (doubling r gives 8x volume), which is why larger cells have a lower surface-area-to-volume ratio."
  },
  {
    id: "2.2-6",
  ...
  {
    id: "2.2-9",
    question: "Which of the following cell shapes would have the LEAST favorable (lowest) surface-area-to-volume ratio for a given volume?",
    options: ["A flattened, thin disc shape", "A long, thin cylindrical shape", "A perfect sphere", "A shape with many membrane folds"],
    correctIndex: 2,
    explanation: "For a fixed volume, a sphere has the minimum possible surface area of any shape, giving it the lowest (least favorable) surface-area-to-volume ratio."
  },
  {
    id: "2.2-10",
