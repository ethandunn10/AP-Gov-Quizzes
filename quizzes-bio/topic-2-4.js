// quizzes-bio/topic-2-4.js
// Unit 2: Cell Structure and Function — Topic 2.4: Membrane Permeability
// Registered in quizzes-bio/index.js as "bio-topic-2-4".
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "2.4-3",
    question: "Large or charged molecules, such as glucose or ions, typically cross the plasma membrane via:",
    options: ["Direct diffusion through the lipid bilayer", "Transport proteins embedded in the membrane", "Evaporation", "They cannot cross the membrane under any circumstances"],
    correctIndex: 1,
    explanation: "Because large or charged/polar molecules cannot easily pass through the hydrophobic membrane interior, they require specific transport proteins (channels or carriers) to cross."
  },
  {
    id: "2.4-4",
  ...
  {
    id: "2.4-7",
    question: "Ions such as Na+ and K+ generally require which type of membrane protein to cross the plasma membrane?",
    options: ["No protein is needed; ions diffuse freely", "Ion channel or carrier proteins", "Structural proteins only", "Enzymes that break down the ion"],
    correctIndex: 1,
    explanation: "Charged ions cannot cross the hydrophobic membrane interior unassisted, so they rely on specific ion channel or carrier proteins to move across the membrane."
  },
  {
    id: "2.4-8",
