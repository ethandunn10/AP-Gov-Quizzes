...
window.QUIZ_QUESTIONS = [
  {
    ...
    options: ["Carbon dioxide, water, and usable energy (ATP)", "Glucose and oxygen", "Only heat with no ATP produced", "Chlorophyll and light energy"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["Cytoplasm", "Mitochondrial matrix", "Thylakoid membrane", "Nucleus"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Directly becoming ATP molecules themselves", "Donating electrons to the electron transport chain, which powers a proton gradient used by ATP synthase to make ATP", "Breaking down glucose directly into ATP", "Splitting water molecules"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Serve as the final electron acceptor at the end of the electron transport chain, forming water", "Directly synthesize ATP without any other steps", "Bind to glucose to start glycolysis", "Replace NADH in the citric acid cycle"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["Produce large quantities of ATP directly", "Regenerate NAD+ from NADH so that glycolysis can continue producing small amounts of ATP", "Replace the need for glycolysis entirely", "Directly power the electron transport chain without oxygen"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Ethanol and carbon dioxide", "Lactate (lactic acid), regenerating NAD+", "Glucose", "Oxygen"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Skips glycolysis entirely", "Fully oxidizes glucose through the citric acid cycle and electron transport chain, extracting much more of the energy stored in glucose's bonds", "Uses only the first step of glycolysis", "Does not require oxygen at all"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Increased ATP production", "A halt in electron transport, collapse of the proton gradient, and a severe drop in ATP production", "Immediate increase in oxygen consumption", "No effect on cellular respiration at all"],
    correctIndex: 1,
