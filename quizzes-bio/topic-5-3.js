// quizzes-bio/topic-5-3.js
// Unit 5: Heredity — Topic 5.3: Mendelian Genetics
// Registered in quizzes-bio/index.js as "bio-topic-5-3".
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5.3-3",
    question: "In a monohybrid cross between two heterozygous (Aa x Aa) parents, what phenotypic ratio is expected in the offspring, assuming complete dominance?",
    options: ["1:1", "1:2:1", "3:1", "9:3:3:1"],
    correctIndex: 2,
    explanation: "Crossing two heterozygotes (Aa x Aa) with complete dominance yields a genotypic ratio of 1 AA : 2 Aa : 1 aa, which translates to a 3:1 phenotypic ratio (dominant to recessive)."
  },
  {
    id: "5.3-4",
    question: "A dihybrid cross between two individuals heterozygous for two independently assorting genes (AaBb x AaBb) is expected to produce offspring in what phenotypic ratio?",
    options: ["3:1", "1:2:1", "9:3:3:1", "1:1:1:1"],
    correctIndex: 2,
    explanation: "A dihybrid cross between two double heterozygotes, assuming independent assortment and complete dominance for both genes, produces a classic 9:3:3:1 phenotypic ratio."
  },
  {
    id: "5.3-5",
  ...
  {
    id: "5.3-7",
    question: "In humans, if brown eyes (B) are dominant over blue eyes (b), a cross between two heterozygous (Bb) parents would be expected to produce children with blue eyes in approximately what proportion?",
    options: ["0%", "25%", "50%", "100%"],
    correctIndex: 1,
    explanation: "A Bb x Bb cross yields a 1:2:1 genotypic ratio (BB:Bb:bb), meaning approximately 25% of offspring are expected to be bb (homozygous recessive) and show the blue-eyed phenotype."
  },
  {
    id: "5.3-8",
