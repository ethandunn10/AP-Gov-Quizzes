// quizzes-bio/topic-6-3.js
// Unit 6: Gene Expression and Regulation — Topic 6.3: Transcription and RNA Processing
// Registered in quizzes-bio/index.js as "bio-topic-6-3".
window.QUIZ_QUESTIONS = [
  {
    id: "6.3-1",
    question: "RNA polymerase initiates transcription by binding to a specific DNA sequence called the:",
    options: ["Terminator", "Promoter", "Operator", "Enhancer only"],
    correctIndex: 1,
    explanation: "The promoter is the DNA sequence upstream of a gene where RNA polymerase (often with help from transcription factors) binds to begin transcription."
  },
  {
    id: "6.3-2",
    question: "During transcription, the template DNA strand is read in which direction, and the new RNA strand grows in which direction?",
    options: ["Template read 5' to 3'; RNA grows 3' to 5'", "Template read 3' to 5'; RNA grows 5' to 3'", "Both read and grow 5' to 3'", "Both read and grow 3' to 5'"],
    correctIndex: 1,
    explanation: "RNA polymerase reads the template strand 3' to 5' while synthesizing the complementary RNA strand in the 5' to 3' direction, matching how DNA polymerase works."
  },
  {
    id: "6.3-3",
