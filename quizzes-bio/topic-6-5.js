// quizzes-bio/topic-6-5.js
// Unit 6: Gene Expression and Regulation — Topic 6.5: Regulation of Gene Expression
// Registered in quizzes-bio/index.js as "bio-topic-6-5".
window.QUIZ_QUESTIONS = [
  {
    id: "6.5-1",
    question: "In prokaryotes, genes that are functionally related are often organized into a single regulatory unit called an:",
    options: ["Exon", "Operon", "Intron", "Anticodon"],
    correctIndex: 1,
    explanation: "An operon is a cluster of genes transcribed together under control of a single promoter and regulatory sequence, common in bacteria (e.g., the lac operon)."
  },
  {
    id: "6.5-2",
  ...
  {
    id: "6.5-3",
    question: "Negative regulation of gene expression involves a regulatory protein that:",
    options: ["Activates transcription", "Represses or blocks transcription", "Has no effect on transcription", "Only affects translation, never transcription"],
    correctIndex: 1,
    explanation: "In negative regulation, a repressor protein binds to DNA (often at an operator) and blocks RNA polymerase from transcribing the gene, decreasing gene expression."
  },
  {
    id: "6.5-4",
