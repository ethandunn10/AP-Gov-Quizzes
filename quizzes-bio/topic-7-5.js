...
window.QUIZ_QUESTIONS = [
  {
    ...
    options: ["The two allele frequencies, p + q = 1", "The number of individuals in a population", "The rate of mutation per gene", "Two different related species"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["A way to guarantee evolution never occurs", "A null model for detecting evolution", "A method for cloning target genes", "A tool used only in biotechnology labs"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["They remain constant across generations", "They always increase for the dominant allele", "They randomly fluctuate wildly", "They immediately reach 100% for one allele"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["The exact number of species in an ecosystem", "Carrier frequency for a recessive disorder", "The rate of photosynthesis in plants", "The structure of a cell membrane"],
    correctIndex: 1,
