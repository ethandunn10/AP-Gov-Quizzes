...
// Registered in quizzes-euro/index.js as "euro-topic-1-1".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "1-1-3",
    question: "The fall of Constantinople in 1453 contributed to the Renaissance primarily by",
    options: [
      "ending Ottoman interest in trade with the states of western Europe",
      "destroying the last surviving copies of major Greek philosophical texts",
      "sending Greek-speaking scholars and manuscripts westward into Italy",
      "forcing the papacy to relocate its administration from Rome to Florence"
    ],
    correctIndex: 2,
    explanation: "Byzantine scholars fleeing the Ottoman conquest carried Greek learning and texts into Italian cities, enriching humanist scholarship. The texts were preserved rather than destroyed, and the papacy remained in Rome."
  },
  {
    id: "1-1-4",
