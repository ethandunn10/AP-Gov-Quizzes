...
// Registered in quizzes-euro/index.js as "euro-topic-1-3".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "1-3-8",
    question: "The northern Renaissance emphasis on 'the philosophy of Christ' meant",
    options: [
      "a system of formal logic used to prove Christian doctrine",
      "the claim that Christ's teaching applied only to ordained clergy",
      "the argument that theology should be written solely in Latin",
      "a simple inward piety modeled on the gospels, not on ritual"
    ],
    correctIndex: 3,
    explanation: "Erasmus urged Christians toward the moral example of the gospels instead of elaborate ceremony and scholastic argument. He wrote for a lay audience and wanted scripture translated widely."
  },
  {
    id: "1-3-9",
    question: "Comparing Italian and northern humanism, the strongest similarity is that both",
    options: [
      "returned to the original ancient sources and read them critically",
      "aimed above all at the political unification of their respective regions",
      "rejected the value of studying Greek and Hebrew in favor of Latin",
      "were sponsored primarily by monastic orders rather than lay patrons"
    ],
    correctIndex: 0,
    explanation: "Whether the source was Cicero or Saint Paul, humanists insisted on going ad fontes and reading it in the original language. Their targets differed, but the scholarly method was shared."
  },
  {
    id: "1-3-10",
