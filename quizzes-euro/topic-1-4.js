...
// Registered in quizzes-euro/index.js as "euro-topic-1-4".
// Topic 1.4 — Printing
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "1-4-5",
    question: "The church's response to printing included",
    options: [
      "a decision to abandon Latin entirely in favor of vernacular publication",
      "granting every bishop a personal monopoly over printing in his diocese",
      "an Index of Prohibited Books naming works Catholics could not read",
      "an outright ban on the operation of printing presses anywhere in Europe"
    ],
    correctIndex: 2,
    explanation: "Rome tried to control circulation through censorship and the Index rather than by suppressing the technology, which was impossible. The church itself used printing extensively."
  },
  {
    id: "1-4-6",
  ...
  {
    id: "1-4-8",
    question: "Printing strengthened the authority of rulers by allowing them to",
    options: [
      "replace spoken proclamations with written ones nobody could dispute",
      "issue identical laws, decrees, and propaganda across their lands",
      "prevent any criticism of government from reaching a public audience",
      "eliminate the need for tax collectors and local administrative officials"
    ],
    correctIndex: 1,
    explanation: "Uniform printed texts let a central government say the same thing everywhere at once, which aided administration and royal image-making. It equally armed critics, so control over opinion was never secure."
  },
  {
    id: "1-4-9",
    question: "The 'print revolution' is sometimes questioned by historians who argue that",
    options: [
      "no more than a few hundred books were printed before the year 1600",
      "printed books had no effect on religion, politics, or scholarship",
      "change was gradual, and manuscript culture persisted alongside print",
      "the printing press was never actually adopted outside of Germany"
    ],
    correctIndex: 2,
    explanation: "Handwritten texts continued for decades in law, correspondence, and court circles, and early printed books imitated manuscripts closely. The argument is about pace, not about whether print mattered."
  },
  {
    id: "1-4-10",
    question: "Which best summarizes printing's long-term significance for Europe?",
    options: [
      "It restricted knowledge to a small class of professional printers",
      "It caused the collapse of Europe's universities and scholarly institutions",
      "It ended religious conflict by making doctrine clear to everyone",
      "It made the rapid, wide circulation of ideas possible for the first time"
    ],
    correctIndex: 3,
    explanation: "Reformation, Scientific Revolution, and Enlightenment all depended on ideas travelling faster and further than any individual could carry them. Printing sharpened religious conflict rather than resolving it."
  }
];
