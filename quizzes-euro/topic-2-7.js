...
// Registered in quizzes-euro/index.js as "euro-topic-2-7".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "2-7-4",
    question: "The Catholic Church promoted Baroque art chiefly because it",
    options: [
      "was far cheaper to produce than the art of the preceding century",
      "avoided depicting saints, whose images Protestants had attacked",
      "could be produced quickly by artists with little formal training",
      "engaged viewers emotionally and asserted the church's confidence"
    ],
    correctIndex: 3,
    explanation: "Trent endorsed images that moved the faithful, and Baroque grandeur answered Protestant austerity with overwhelming sensory appeal. Saints and the Virgin were depicted more, not less."
  },
  {
    id: "2-7-5",
  ...
  {
    id: "2-7-8",
    question: "Court patronage of Baroque art served rulers by",
    options: [
      "projecting royal power and legitimacy through scale and splendor",
      "generating direct revenue from admission charges to royal galleries",
      "replacing taxation as the principal source of state income",
      "demonstrating the monarch's personal skill as a practicing artist"
    ],
    correctIndex: 0,
    explanation: "Palaces, portraits, and ceiling programs made abstract claims of authority visible and permanent. Versailles under Louis XIV is the fullest expression of the strategy."
  },
  {
    id: "2-7-9",
