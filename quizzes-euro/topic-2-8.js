...
// Registered in quizzes-euro/index.js as "euro-topic-2-8".
...
window.QUIZ_QUESTIONS = [
  {
    id: "2-8-1",
    question: "Which causal chain best explains why Luther's challenge became a permanent schism?",
    options: [
      "Printing spread it, princes shielded him, the empire was weak",
      "The papacy accepted his theology, making a negotiated settlement possible",
      "Peasant armies defeated imperial forces and imposed reform by conquest",
      "Ottoman invasion removed Catholic authority from central Europe entirely"
    ],
    correctIndex: 0,
    explanation: "Each element mattered: pamphlets built an audience, Frederick of Saxony sheltered him, and Charles V could not enforce the imperial ban. Earlier critics like Hus had lacked all three."
  },
  {
    id: "2-8-2",
  ...
  {
    id: "2-8-7",
    question: "Which effect of the religious wars proved most consequential for European politics?",
    options: [
      "The permanent abolition of dynastic marriage as a diplomatic tool",
      "The complete disappearance of religion from European public life",
      "The emergence of state sovereignty as the basis of international order",
      "The unification of Europe under a single recognized legal authority"
    ],
    correctIndex: 2,
    explanation: "Westphalia settled that rulers answer to no external religious authority within their own borders, the foundation of the modern state system. Religion remained politically important for centuries."
  },
  {
    id: "2-8-8",
    question: "Which best explains why religious conflict eventually diminished after 1648?",
    options: [
      "Europeans had ceased to hold any strong religious convictions at all",
      "The papacy formally renounced all claims over secular rulers",
      "A single confession had triumphed across the whole of the continent",
      "Exhaustion and the growing priority of state interest over confession"
    ],
    correctIndex: 3,
    explanation: "Decades of devastation and the example of Catholic France backing Protestant powers showed that raison d'état now outranked confessional solidarity. Europe remained religiously divided and devout."
  },
  {
    id: "2-8-9",
    question: "The Reformation's effect on ordinary people is best described as",
    options: [
      "reshaping worship, education, marriage, and charity in daily life",
      "confined entirely to the clergy with no effect on lay households",
      "limited to changes in the language used during church services",
      "negligible, since most people never learned of the religious disputes"
    ],
    correctIndex: 0,
    explanation: "New catechisms, schools, marriage courts, and poor relief reorganized parish life on both sides of the divide. Confession became a marker of identity that shaped whom people married and trusted."
  },
  {
    id: "2-8-10",
