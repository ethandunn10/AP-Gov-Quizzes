...
// Registered in quizzes-euro/index.js as "euro-topic-4-3".
// Topic 4.3 — The Enlightenment

window.QUIZ_QUESTIONS = [
  {
    id: "4-3-1",
    question: "Montesquieu's Spirit of the Laws argued that liberty is best protected by",
    options: [
      "concentrating all authority in a single efficient executive",
      "abolishing the judiciary as an independent branch of government",
      "separating governmental powers so that each checks the others",
      "granting hereditary aristocracies permanent control of legislation"
    ],
    correctIndex: 2,
    explanation: "Dividing legislative, executive, and judicial functions was meant to make tyranny structurally difficult. The design shaped the United States Constitution directly."
  },
  {
    id: "4-3-2",
