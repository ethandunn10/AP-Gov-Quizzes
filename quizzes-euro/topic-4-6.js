...
// Registered in quizzes-euro/index.js as "euro-topic-4-6".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "4-6-4",
    question: "Catherine the Great's record on reform is best described as",
    options: [
  ...
  {
    id: "4-6-10",
    question: "A historian evaluating the term 'enlightened absolutism' would most defensibly argue that",
    options: [
      "these rulers consistently placed subjects' welfare above state interest",
      "the reforms served state power at least as much as Enlightenment ideals",
      "no eighteenth-century ruler showed any interest in Enlightenment thought",
      "the reforms produced constitutional government across central Europe"
    ],
    correctIndex: 1,
    explanation: "Codified law, toleration, and schooling produced more governable, productive, and taxable populations, which is why rulers pursued them. That does not make the interest in reform insincere."
  }
];
