...
// Registered in quizzes-euro/index.js as "euro-topic-5-3".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-3-2",
    question: "The Act of Union of 1707 created",
    options: [
      "a political merger of England with the kingdom of France",
      "a single kingdom of Great Britain joining England and Scotland",
      "a union between Great Britain and the Dutch Republic",
      "an empire uniting Britain with its North American colonies"
    ],
    correctIndex: 1,
    explanation: "Scotland gained access to English markets and colonies while England secured its northern border and the Protestant succession. A single Parliament at Westminster followed."
  },
  {
    id: "5-3-3",
    question: "The British 'financial revolution' gave the state an advantage because",
    options: [
      "it eliminated the need for Britain to collect any taxes at all",
      "the Bank of England lent only to private merchant companies",
      "parliamentary control of taxation made government debt credible",
      "Britain refused on principle to borrow money for military purposes"
    ],
    correctIndex: 2,
    explanation: "Because Parliament voted the taxes that serviced the debt, lenders trusted repayment and interest rates fell. France, with no equivalent guarantee, paid far more to borrow less."
  },
  {
    id: "5-3-4",
  ...
  {
    id: "5-3-7",
    question: "Britain's agricultural changes contributed to its ascendancy because they",
    options: [
      "reduced total food output and so lowered the cost of poor relief",
      "kept the entire rural population employed on smallholdings",
      "freed labor from farming while feeding a growing urban population",
      "eliminated the need for Britain to import any food at all"
    ],
    correctIndex: 2,
    explanation: "Higher yields per worker meant fewer hands were needed on the land just as towns and manufacturing required them. Enclosure was central to that release of labor."
  },
  {
    id: "5-3-8",
  ...
  {
    id: "5-3-9",
    question: "Which factor best explains Britain's advantage over France by 1800?",
    options: [
      "Britain's fiscal credibility, navy, and commercial reach",
      "Britain's avoidance of warfare throughout the eighteenth century",
      "Britain's larger population and more extensive territory in Europe",
      "France's refusal to participate in colonial or maritime commerce"
    ],
    correctIndex: 0,
    explanation: "France was larger and more populous but could not tax or borrow as effectively, and its navy could not protect its trade. Britain fought constantly and financed it better."
  },
  {
    id: "5-3-10",
