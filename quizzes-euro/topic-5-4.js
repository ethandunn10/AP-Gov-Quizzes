...
// Registered in quizzes-euro/index.js as "euro-topic-5-4".
// Topic 5.4 — The French Revolution

window.QUIZ_QUESTIONS = [
  {
    id: "5-4-1",
    question: "Louis XVI summoned the Estates General in 1789 because",
    options: [
      "he intended to grant France a written constitution voluntarily",
      "the parlements had blocked reform and the treasury was exhausted",
      "the Third Estate had demanded it through a national petition",
      "foreign powers required it as a condition of a peace settlement"
    ],
    correctIndex: 1,
    explanation: "With bankruptcy looming and the noble courts refusing to register new taxes, the king had no remaining source of consent. Calling the body for the first time since 1614 opened the political floodgates."
  },
  {
    id: "5-4-2",
    question: "The Tennis Court Oath marked a decisive moment because the Third Estate",
    options: [
      "swore loyalty to the king and accepted voting by separate order",
      "agreed to disband and await the king's decision on taxation",
      "declared itself the National Assembly and vowed a constitution",
      "voted to restore the full privileges of the clergy and nobility"
    ],
    correctIndex: 2,
    explanation: "Claiming to represent the nation rather than one order asserted popular sovereignty against the king's authority. The dispute over voting by head rather than by order had made the break unavoidable."
  },
  {
    id: "5-4-3",
  ...
  {
    id: "5-4-6",
    question: "The Reign of Terror is best explained as a response to",
    options: [
      "the personal ambition of Robespierre acting without any support",
      "a decline in popular enthusiasm for the revolutionary cause",
      "foreign invasion, internal revolt, and economic crisis at once",
      "the restoration of the monarchy by the National Convention"
    ],
    correctIndex: 2,
    explanation: "War on multiple frontiers, the Vendée rising, and food shortages led the Committee of Public Safety to govern by emergency measures. Terror was justified as the price of the Republic's survival."
  },
  {
    id: "5-4-7",
  ...
  {
    id: "5-4-8",
    question: "Olympe de Gouges is remembered for",
    options: [
      "organizing the women's march that brought the king to Paris in 1789",
      "leading the Jacobin club during the height of the Terror",
      "commanding a revolutionary army on the northeastern frontier",
      "writing a declaration of the rights of woman and the female citizen"
    ],
    correctIndex: 3,
    explanation: "She rewrote the 1789 Declaration to include women, exposing how selectively 'universal' rights were applied. She was executed during the Terror."
  },
  {
    id: "5-4-9",
