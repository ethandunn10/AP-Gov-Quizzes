...
// Registered in quizzes-euro/index.js as "euro-topic-5-6".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-6-7",
    question: "Napoleonic rule spread revolutionary institutions across Europe by",
    options: [
      "abolishing feudal obligations and imposing legal codes",
      "restoring the privileges of local nobility wherever French armies went",
      "leaving every conquered territory's laws and institutions untouched",
      "establishing elected parliaments with full sovereignty in each state"
    ],
    correctIndex: 0,
    explanation: "French administration swept away serfdom, guild restrictions, and noble courts in the Rhineland, Italy, and beyond. Those changes often survived Napoleon's fall."
  },
  {
    id: "5-6-8",
