...
// Registered in quizzes-euro/index.js as "euro-topic-5-7".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-7-7",
    question: "Britain's role in the Vienna settlement was distinctive because Britain",
    options: [
      "annexed extensive territory on the European mainland",
      "refused to participate in the negotiations at Vienna",
      "sought naval and colonial gains, not continental land",
      "demanded the complete destruction of the French monarchy"
    ],
    correctIndex: 2,
    explanation: "Britain took strategic bases such as Malta and the Cape while working to keep the continent balanced. Castlereagh also resisted the more repressive interventionist schemes."
  },
  {
    id: "5-7-8",
