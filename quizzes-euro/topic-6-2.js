...
// Registered in quizzes-euro/index.js as "euro-topic-6-2".
// Topic 6.2 — The Spread of Industry
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-2-3",
    question: "Railways affected industrializing economies most fundamentally by",
    options: [
      "cutting transport costs and integrating national markets",
      "eliminating the need for factories in manufacturing production",
      "confining economic activity to narrow coastal strips",
      "reducing the demand for coal and for iron production"
    ],
    correctIndex: 0,
    explanation: "Rail turned regional markets into national ones, moved troops and officials inland, and consumed vast quantities of iron and coal. That consumption stimulated the very industries that built it."
  },
  {
    id: "6-2-4",
    ...
    correctIndex: 1,
    explanation: "Coal in Wallonia, an established textile tradition, and active government backing made Belgium the first continental industrial economy. British engineers were welcomed rather than excluded."
  },
  {
    id: "6-2-5",
  ...
  {
    id: "6-2-9",
    question: "Industrialization spread more slowly in southern and eastern Europe because of",
    options: [
      "a deliberate choice by their populations to remain agricultural",
      "government bans on the construction of railways in those regions",
      "serfdom or its legacy, scarce capital, and poor transport links",
      "the complete absence of coal deposits anywhere in those regions"
    ],
    correctIndex: 2,
    explanation: "Unfree or recently freed labor, thin credit markets, and vast distances without infrastructure all slowed industrial growth. Russia and the Balkans had coal but struggled to exploit it early."
  },
  {
    id: "6-2-10",
