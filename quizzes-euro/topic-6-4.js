...
// Registered in quizzes-euro/index.js as "euro-topic-6-4".
...
window.QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "Cholera outbreaks and reports such as Chadwick's documented the link between filth and mortality, forcing cities to build sewers and water systems. These were among the largest public works of the century."
  },
  {
    id: "6-4-9",
    question: "The standard of living debate among historians concerns whether",
    options: [
      "industrialization occurred in Britain before it occurred elsewhere",
      "factory production was more efficient than cottage manufacturing",
      "early industrial workers gained or lost materially before about 1850",
      "European population grew during the nineteenth century at all"
    ],
    correctIndex: 2,
    explanation: "Optimists point to rising real wages and pessimists to housing, hours, and health in the first industrial decades. Most historians accept substantial improvement after mid-century."
  },
  {
    id: "6-4-10",
