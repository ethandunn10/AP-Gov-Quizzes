...
// Registered in quizzes-euro/index.js as "euro-topic-6-6".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-6-4",
    question: "The Frankfurt Parliament of 1848 failed primarily because",
    options: [
      "its members refused to discuss the question of German unification",
      "Austria and Prussia had already unified Germany by that date",
      "it was suppressed by a French army marching into the Rhineland",
      "it lacked an army and the Prussian king refused its offered crown"
    ],
    correctIndex: 3,
    explanation: "An assembly of liberal professors and lawyers had no force to impose its constitution, and Frederick William IV would not accept a crown from a popular body. Unification came later through Prussian arms instead."
  },
  {
    id: "6-6-5",
    question: "The February 1848 revolution in France led first to",
    options: [
      "the Second Republic, with universal male suffrage",
      "the immediate coronation of Louis Napoleon as emperor",
      "a restoration of Bourbon monarchy under a new charter",
      "the partition of France among the conservative great powers"
    ],
    correctIndex: 0,
    explanation: "Louis Philippe fled and the new republic granted all adult men the vote, a dramatic democratic expansion. Louis Napoleon was elected president and made himself emperor only in 1852."
  },
  {
    id: "6-6-6",
