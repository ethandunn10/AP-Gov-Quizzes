...
// Registered in quizzes-euro/index.js as "euro-topic-6-7".
// Topic 6.7 — Ideologies of Change
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-7-5",
    question: "Revisionist socialists such as Bernstein differed from orthodox Marxists by arguing that",
    options: [
      "socialism could be achieved gradually through democratic politics",
      "capitalism would collapse far sooner than Marx had predicted",
      "workers should abandon trade unions and electoral participation",
      "private property should be preserved exactly as it existed"
    ],
    correctIndex: 0,
    explanation: "Rising wages and expanding suffrage suggested to Bernstein that reform could achieve what revolution promised. The dispute split European socialist parties well before 1914."
  },
  {
    id: "6-7-6",
