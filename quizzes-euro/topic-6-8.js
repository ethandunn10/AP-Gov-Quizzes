...
// Registered in quizzes-euro/index.js as "euro-topic-6-8".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-8-5",
    question: "Public health reform in nineteenth-century cities was prompted by",
    options: [
      "a decline in urban population that freed municipal budgets",
      "the finding that sanitation had no effect on rates of disease",
      "cholera epidemics and statistics linking filth to death",
      "employers' campaigns to reduce the size of the urban workforce"
    ],
    correctIndex: 2,
    explanation: "Chadwick's reports and repeated cholera outbreaks made the case for sewers and clean water. These became among the largest public works projects of the century."
  },
  {
    id: "6-8-6",
  ...
  {
    id: "6-8-7",
    question: "Education reform expanded in the later nineteenth century because states",
    options: [
      "needed literate, disciplined citizens, workers, and conscripts",
      "wished to reduce the number of children available for factory work",
      "had been ordered to do so by international agreement",
      "sought to restrict schooling to the children of property owners"
    ],
    correctIndex: 0,
    explanation: "Compulsory schooling served industry, the army, and nation-building at once, and it spread across Europe after 1870. Removing children from factories was a welcome side effect rather than the main aim."
  },
  {
    id: "6-8-8",
