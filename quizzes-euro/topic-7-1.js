...
// Registered in quizzes-euro/index.js as "euro-topic-7-1".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "7-1-3",
    question: "Scientific and intellectual developments after 1850 affected European thought by",
    options: [
      "encouraging faith in progress while unsettling belief",
      "proving that human society could never be studied systematically",
      "restoring theology as the organizing framework for all knowledge",
      "eliminating scientific inquiry in favor of Romantic intuition"
    ],
    correctIndex: 0,
    explanation: "Darwin, positivism, and medical advances fed optimism about progress while raising hard questions about scripture and human nature. That combination of confidence and doubt defines the period."
  },
  {
    id: "7-1-4",
  ...
  {
    id: "7-1-8",
    question: "Which factor most contributed to international tension in the decades before 1914?",
    options: [
      "Universal agreement on the borders of every European state",
      "Alliance commitments, arms racing, and imperial rivalry",
      "The absence of any military planning by the great powers",
      "The elimination of colonial competition among European powers"
    ],
    correctIndex: 1,
    explanation: "Rigid alliances, naval and army competition, and colonial crises hardened Europe into two camps. Detailed mobilization plans then narrowed the room for diplomacy in a crisis."
  },
  {
    id: "7-1-9",
    question: "The relationship between nationalism and imperialism in this era was that",
    options: [
      "colonial expansion reduced rivalry among European nation-states",
      "nationalists universally opposed the acquisition of overseas colonies",
      "national prestige became measured by the extent of overseas empire",
      "imperialism was pursued only by states without national identities"
    ],
    correctIndex: 2,
    explanation: "Once colonies signified great-power status, newly unified Germany and Italy pursued territory of little economic value. Colonial crises then fed back into European rivalry."
  },
  {
    id: "7-1-10",
