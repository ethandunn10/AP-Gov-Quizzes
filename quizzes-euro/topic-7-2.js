...
// Registered in quizzes-euro/index.js as "euro-topic-7-2".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "7-2-4",
    question: "The Ausgleich of 1867 addressed nationalist pressure by",
    options: [
      "granting full independence to Hungary as a separate sovereign state",
      "abolishing the Habsburg monarchy in favor of a federal republic",
      "extending equal national rights to every people in the empire",
      "creating a dual monarchy in which Hungary gained internal self-rule"
    ],
    correctIndex: 3,
    explanation: "Austria-Hungary shared a monarch, army, and foreign policy while Hungary governed its internal affairs. Slavic peoples resented a settlement that satisfied only the two strongest nationalities."
  },
  {
    id: "7-2-5",
    question: "Nationalism in the Balkans was especially destabilizing because",
    options: [
      "competing national claims overlapped and drew in the great powers",
      "the region contained only one clearly defined national group",
      "Ottoman authority there had already collapsed entirely by 1815",
      "no great power had any strategic interest in the Balkan peninsula"
    ],
    correctIndex: 0,
    explanation: "Serbian, Greek, Bulgarian, and Romanian aspirations overlapped in mixed territories, and Russia and Austria-Hungary backed rival clients. The region's nickname as Europe's powder keg reflects that combination."
  },
  {
    id: "7-2-6",
    question: "Zionism emerged in the late nineteenth century in response to",
    options: [
      "the complete legal emancipation of Jews throughout Europe",
      "persistent antisemitism and doubts that assimilation would succeed",
      "an invitation from the Ottoman Empire to settle in Palestine",
      "the disappearance of Jewish communities from eastern Europe"
    ],
    correctIndex: 1,
    explanation: "Russian pogroms and the Dreyfus affair convinced Herzl that legal emancipation would not secure Jewish safety in Europe. Zionism applied the national principle to a people without territory."
  },
  {
    id: "7-2-7",
    question: "Governments in the later nineteenth century used nationalism to",
    options: [
      "encourage subject peoples to seek independence from their states",
      "justify transferring sovereignty to international organizations",
      "build loyalty through schooling, conscription, and symbols",
      "eliminate the teaching of national history in public schools"
    ],
    correctIndex: 2,
    explanation: "Compulsory schooling in a national language, universal conscription, flags, and holidays manufactured citizens' identification with the state. Conservatives learned to harness what they had once feared."
  },
  {
    id: "7-2-8",
