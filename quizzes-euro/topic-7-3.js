...
// Registered in quizzes-euro/index.js as "euro-topic-7-3".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "7-3-2",
    question: "Cavour's diplomatic strategy for Italian unification depended on",
    options: [
      "securing a great-power ally to fight Austria alongside Piedmont",
      "persuading Austria to withdraw voluntarily from northern Italy",
      "obtaining a guarantee of neutrality from every European power",
      "avoiding all warfare in favor of negotiated territorial transfers"
    ],
    correctIndex: 0,
    explanation: "The Plombières agreement brought France into war against Austria in 1859, which Piedmont could not have won alone. Cavour then managed the annexations that followed."
  },
  {
    id: "7-3-3",
  ...
  {
    id: "7-3-6",
    question: "Bismarck's diplomacy after 1871 aimed primarily at",
    options: [
      "acquiring extensive additional territory in western Europe",
      "isolating France and preventing a coalition against Berlin",
      "dissolving the German Empire he had just created",
      "forming a permanent alliance between Germany and France"
    ],
    correctIndex: 1,
    explanation: "He declared Germany satisfied and built overlapping alliances to keep France without allies. His successors abandoned that restraint, allowing the Franco-Russian alliance to form."
  },
  {
    id: "7-3-7",
    question: "The alliance system before 1914 divided Europe into",
    options: [
      "a single alliance including every major European power",
      "blocs organized strictly along Catholic and Protestant lines",
      "the Triple Alliance and the Triple Entente",
      "coalitions based entirely on colonial possessions in Africa"
    ],
    correctIndex: 2,
    explanation: "Germany, Austria-Hungary, and Italy faced France, Russia, and Britain, though Italy later switched sides. These commitments converted a Balkan crisis into a continental war."
  },
  {
    id: "7-3-8",
    question: "The Anglo-German naval race contributed to tension because it",
    options: [
      "threatened a naval supremacy Britain regarded as existential",
      "was settled peacefully by treaty well before the year 1914",
      "had no effect on British diplomatic alignments in Europe",
      "gave Germany clear naval superiority by the year 1910"
    ],
    correctIndex: 0,
    explanation: "Tirpitz's dreadnought program pushed Britain to treat Germany as the primary threat and to abandon its traditional distance from continental alliances. No limitation agreement was reached."
  },
  {
    id: "7-3-9",
