...
// Registered in quizzes-euro/index.js as "euro-topic-7-7".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "7-7-2",
    question: "Colonial infrastructure such as railways was generally built to",
    options: [
      "link interior regions to one another for local trade",
      "serve passenger travel between African and Asian cities",
      "provide irrigation for subsistence food production",
      "connect mines and plantations to ports for export"
    ],
    correctIndex: 3,
    explanation: "Colonial rail maps typically run from resource sites straight to the coast with little lateral connection. That geography outlasted colonial rule and constrained later development."
  },
  {
    id: "7-7-3",
  ...
  {
    id: "7-7-5",
    question: "Colonial borders drawn by European powers created lasting problems because they",
    options: [
      "left every colony too small to function as an independent state",
      "corresponded precisely to existing ethnic and political divisions",
      "divided communities and grouped rivals within single territories",
      "were redrawn by African and Asian states immediately at independence"
    ],
    correctIndex: 2,
    explanation: "Lines drawn in European capitals split peoples and enclosed groups with no shared political history. Successor states inherited those borders and the conflicts built into them."
  },
  {
    id: "7-7-6",
  ...
  {
    id: "7-7-10",
    question: "A historian assessing imperialism's long-term effects would emphasize",
    options: [
      "the equal development of colonizing and colonized societies",
      "the voluntary nature of the relationships that empire created",
      "the complete absence of lasting consequences after decolonization",
      "economic structures and borders that shaped the postcolonial world"
    ],
    correctIndex: 3,
    explanation: "Commodity dependence, export-oriented infrastructure, and inherited boundaries constrained newly independent states for decades. Those legacies outlived formal colonial rule by generations."
  }
];
