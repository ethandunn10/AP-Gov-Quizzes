...
// Registered in quizzes-euro/index.js as "euro-topic-7-9".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "7-9-2",
    question: "Which is best classified as a long-term cause of the First World War?",
    options: [
      "The assassination of Archduke Franz Ferdinand in June 1914",
      "The Austrian ultimatum delivered to Serbia in July 1914",
      "Alliance systems, arms racing, and imperial rivalry over decades",
      "The German invasion of Belgium in August of the year 1914"
    ],
    correctIndex: 2,
    explanation: "Structures built over thirty years made a general war likely once any serious crisis occurred; the 1914 events are triggers within that framework. Distinguishing the two is the skill being tested."
  },
  {
    id: "7-9-3",
  ...
  {
    id: "7-9-8",
    question: "The rise of mass politics resulted most directly from",
    options: [
      "the abolition of political parties across nineteenth-century Europe",
      "the decision of governments to end parliamentary elections",
      "the narrowing of the franchise to smaller propertied electorates",
      "franchise expansion, mass literacy, and cheap newspapers"
    ],
    correctIndex: 3,
    explanation: "Larger electorates required organizations that could mobilize them, and the penny press supplied the medium. Politics shifted from court influence toward competition for public opinion."
  },
  {
    id: "7-9-9",
    question: "Which effect of nineteenth-century developments proved most consequential for the next century?",
    options: [
      "The growth of commercial leisure and spectator sport in European cities",
      "Industrial and military capacity that made total war possible",
      "The construction of monumental iron and glass exhibition halls",
      "The spread of Impressionist painting beyond France into Europe"
    ],
    correctIndex: 1,
    explanation: "Mass-produced artillery, railways, and conscript armies made the casualties of 1914-1918 possible. The other options were real changes but of far smaller consequence."
  },
  {
    id: "7-9-10",
