...
// Registered in quizzes-euro/index.js as "euro-topic-8-11".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "8-11-3",
    question: "The role of the state in European economies changed such that by 1945 states",
    options: [
      "had withdrawn entirely from economic management and planning",
      "had returned to the laissez-faire practice of the 1870s",
      "accepted responsibility for employment, welfare, and planning",
      "had transferred economic policy to international organizations"
    ],
    correctIndex: 2,
    explanation: "Wartime mobilization and Depression-era experience made economic management a permanent state function. The postwar welfare states built directly on that precedent."
  },
  {
    id: "8-11-4",
  ...
  {
    id: "8-11-6",
    question: "A student argues that the interwar years were simply a pause between wars. The best qualification is that",
    options: [
      "no significant political or economic change occurred between 1918 and 1939",
      "the period saw real stabilization and cultural innovation",
      "the two wars were entirely unconnected conflicts with separate causes",
      "European states made no attempt at collective security in these years"
    ],
    correctIndex: 1,
    explanation: "Locarno, the Dawes Plan, new democracies, and modernist culture were real developments, not merely an interval. The claim is too deterministic rather than wholly wrong."
  },
  {
    id: "8-11-7",
