...
// Registered in quizzes-euro/index.js as "euro-topic-8-2".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "8-2-2",
    question: "The Schlieffen Plan widened the war because it required Germany to",
    options: [
      "remain strictly neutral in any conflict involving France",
      "concentrate its entire army on the Russian frontier alone",
      "seek British mediation before commencing any military action",
      "attack France through Belgium at the outset of war with Russia"
    ],
    correctIndex: 3,
    explanation: "Fear of a two-front war converted an eastern crisis into an invasion of the west, and violating Belgian neutrality brought Britain in. A military timetable thus dictated the war's geography."
  },
  {
    id: "8-2-3",
  ...
  {
    id: "8-2-10",
    question: "A historian assessing the First World War's significance would emphasize that it",
    options: [
      "involved only the states of western Europe in the fighting",
      "left European political boundaries and institutions unchanged",
      "resolved the tensions that had produced it before 1914",
      "destroyed four empires and shattered confidence in progress"
    ],
    correctIndex: 3,
    explanation: "The Romanov, Habsburg, Ottoman, and Hohenzollern empires all fell, and the war's carnage discredited the nineteenth century's faith in improvement. Its unresolved settlement led directly to the next war."
  }
];
