...
// Registered in quizzes-euro/index.js as "euro-topic-8-4".
// Topic 8.4 — Versailles Conference
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "8-4-4",
    question: "The mandate system established after the war is best described as",
    options: [
      "immediate independence for former Ottoman and German territories",
      "Allied administration under League oversight, colonial in practice",
      "joint governance of these territories by their own elected assemblies",
      "the return of these territories to their prewar imperial rulers"
    ],
    correctIndex: 1,
    explanation: "Mandates were justified as preparation for eventual self-rule but functioned as colonies run by Britain and France. The gap between rhetoric and reality fueled nationalist anger."
  },
  {
    id: "8-4-5",
