...
// Registered in quizzes-euro/index.js as "euro-topic-8-5".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "8-5-5",
    question: "Abandoning the gold standard helped economies recover because it",
    options: [
      "freed states to expand money and devalue rather than defend parity",
      "forced governments to cut public spending even further",
      "required the immediate repayment of all foreign debt",
      "eliminated international trade and so protected domestic industry"
    ],
    correctIndex: 0,
    explanation: "Defending gold parity meant deflation and high interest rates in the middle of a slump. Countries that left the standard earlier generally recovered earlier."
  },
  {
    id: "8-5-6",
  ...
  {
    id: "8-5-8",
    question: "The Soviet Union's experience of the 1930s differed from the West's because it",
    options: [
      "suffered a deeper economic contraction than any Western state",
      "adopted Keynesian deficit spending to restore employment",
      "abandoned central planning in favor of market allocation",
      "was insulated from world markets and reported industrial growth"
    ],
    correctIndex: 3,
    explanation: "Autarky and the Five-Year Plans meant Soviet industry grew while Western economies contracted, which impressed some Western observers. The human cost of collectivization was concealed."
  },
  {
    id: "8-5-9",
    question: "The Depression contributed to international instability because it",
    options: [
      "encouraged states to pursue autarky and territorial expansion",
      "persuaded governments to reduce their military expenditure",
      "strengthened the League of Nations' authority over its members",
      "eliminated competition for raw materials among the great powers"
    ],
    correctIndex: 0,
    explanation: "Japan in Manchuria and later Germany and Italy justified expansion as a search for secure resources and markets. Economic nationalism and territorial aggression reinforced one another."
  },
  {
    id: "8-5-10",
