...
// Registered in quizzes-euro/index.js as "euro-topic-8-7".
// Topic 8.7 — Europe During the Interwar Period

window.QUIZ_QUESTIONS = [
  {
    id: "8-7-1",
    question: "The Weimar Republic faced fundamental difficulties because it",
    options: [
      "was blamed for Versailles and faced attacks from left and right",
      "had no written constitution or elected legislative body",
      "was governed directly by the Allied occupation authorities",
      "refused to hold any national elections between 1919 and 1933"
    ],
    correctIndex: 0,
    explanation: "The 'stab in the back' myth tied the republic to national humiliation, and communists and nationalists both sought its overthrow. Proportional representation also produced unstable coalitions."
  },
  {
    id: "8-7-2",
  ...
  {
    id: "8-7-7",
    question: "Interwar France was politically unstable largely because of",
    options: [
      "the refusal of French governments to hold national elections",
      "France's occupation by a foreign power throughout the period",
      "deep left-right division and short-lived coalition governments",
      "the absence of any organized political parties in the country"
    ],
    correctIndex: 2,
    explanation: "The Popular Front and the leagues of the right reflected a society polarized over economics and the memory of 1914. Rapid cabinet turnover weakened France's response to German rearmament."
  },
  {
    id: "8-7-8",
  ...
  {
    id: "8-7-9",
    question: "Eastern European states created after 1918 generally",
    options: [
      "drifted toward authoritarian rule amid ethnic and economic strain",
      "avoided all ethnic tension because their borders matched nationalities",
      "became stable parliamentary democracies that endured until 1945",
      "voluntarily merged into a single federal central European state"
    ],
    correctIndex: 0,
    explanation: "Minority conflicts, land hunger, and depression pushed most of these states toward authoritarian government by the 1930s. Czechoslovakia was the notable democratic exception."
  },
  {
    id: "8-7-10",
