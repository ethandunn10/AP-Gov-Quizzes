...
// Registered in quizzes-hug/index.js as "hug-topic-2-10".
...
window.QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: "His nineteenth-century observations still describe much migration, including the finding that economic motives dominate. Most migration remains internal rather than international."
  },
  {
    id: "2-10-5",
    question: "Economic migration is typically driven by",
    options: [
      "differences in wages and employment between places",
      "identical economic conditions in origin and destination",
      "government prohibitions on all forms of employment",
      "the absence of any transportation between regions"
    ],
    correctIndex: 0,
    explanation: "Wage gaps and job availability explain most voluntary movement, both internal and international. Networks of earlier migrants then lower the cost of following."
  },
  {
    id: "2-10-6",
  ...
  {
    id: "2-10-8",
    question: "Step migration describes movement that occurs",
    options: [
      "in a series of stages, often from village to town to city",
      "directly from a rural village to a foreign capital",
      "only among highly educated professional workers",
      "exclusively in the reverse direction, from city to countryside"
    ],
    correctIndex: 0,
    explanation: "Migrants frequently move up the settlement hierarchy in increments rather than all at once. Each step provides resources and information for the next."
  },
  {
    id: "2-10-9",
  ...
  {
    id: "2-10-10",
    question: "A geographer explaining why migrants from one village concentrate in one city would cite",
    options: [
      "chain migration through family and social networks",
      "the gravity model applied to the two locations' populations",
      "intervening obstacles encountered along the migration route",
      "environmental push factors operating in the destination city"
    ],
    correctIndex: 0,
    explanation: "Networks channel movement along established paths, which is why specific origin-destination pairs recur. The gravity model predicts overall volume but not this concentration."
  }
];
