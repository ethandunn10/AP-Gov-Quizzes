...
// Registered in quizzes-hug/index.js as "hug-topic-2-12".
...
window.QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      "the return of skilled workers to their country of origin",
      "the emigration of educated professionals from a country",
      "the decline in educational quality within a school system",
      "the recruitment of unskilled laborers for seasonal work"
    ],
    correctIndex: 1,
    explanation: "Doctors, engineers, and academics leaving deprives origin countries of skills their education systems paid to produce. Brain gain occurs when those migrants later return with added expertise."
  },
  {
    id: "2-12-3",
    ...
    correctIndex: 2,
    explanation: "Because migrants are mostly young adults, sending areas lose the cohort that works and raises children. Rural depopulation in Europe and Latin America follows this pattern."
  },
  {
    id: "2-12-4",
    question: "Receiving countries commonly experience which demographic effect from immigration?",
    options: [
      "A rise in the median age of the national population",
      "An immediate decline in the total population size",
      "The complete elimination of labor shortages in all sectors",
      "A younger age structure and partial offset of low fertility"
    ],
    correctIndex: 3,
    explanation: "Arriving working-age migrants and their children slow population aging and expand the tax base. Several European countries would be shrinking without net immigration."
  },
  {
    id: "2-12-5",
