...
// Registered in quizzes-hug/index.js as "hug-topic-2-3".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "2-3-2",
    question: "A population pyramid with a very wide base indicates",
    options: [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: "Fewer children than adults means each generation is smaller than the last, pointing toward decline. Japan and several European countries show this pattern."
  },
  {
    id: "2-3-4",
    question: "The dependency ratio measures",
    options: [
      "the proportion of a population that lives in urban areas",
      "the number of migrants relative to the native-born population",
      "the ratio of male to female residents in a population",
      "the ratio of dependent-age people to working-age people"
    ],
    correctIndex: 3,
    explanation: "Combining those under 15 and over 64 against the working-age group indicates the burden on producers. High ratios strain schools in young countries and pensions in old ones."
  },
  {
    id: "2-3-5",
    question: "A youth bulge in a population pyramid can create",
    options: [
      "opportunity if jobs exist, instability if they do not",
      "an immediate and permanent shortage of available workers",
      "guaranteed economic growth regardless of employment conditions",
      "a rapid increase in the proportion of elderly residents"
    ],
    correctIndex: 0,
    explanation: "A large working-age cohort can produce a demographic dividend when absorbed into employment, or unrest when it is not. Outcomes depend on economic and political conditions."
  },
  {
    id: "2-3-6",
  ...
  {
    id: "2-3-8",
    question: "A city with a pyramid bulging in the young adult cohorts most likely",
    options: [
      "has experienced heavy out-migration of working-age residents",
      "attracts in-migration for employment or education",
      "has an unusually high death rate among older residents",
      "has recently experienced a sharp rise in its birth rate"
    ],
    correctIndex: 1,
    explanation: "Migrants are disproportionately young adults, so receiving areas show swollen middle cohorts. Sending areas show the mirror image, with those cohorts thinned."
  },
  {
    id: "2-3-9",
