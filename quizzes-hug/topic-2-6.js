...
// Registered in quizzes-hug/index.js as "hug-topic-2-6".
...
window.QUIZ_QUESTIONS = [
  {
    ...
    options: [
      "food supply grows faster than population in all circumstances",
      "population growth has no relationship to available resources",
      "population grows geometrically, food supply arithmetically",
      "technological innovation removes all limits on population growth"
    ],
    correctIndex: 2,
    explanation: "Malthus predicted that compounding population would outrun a food supply that increased by fixed increments. Famine, disease, and war were his checks on that growth."
  },
  {
    id: "2-6-2",
