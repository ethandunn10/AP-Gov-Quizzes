...
// Registered in quizzes-hug/index.js as "hug-topic-2-7".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "2-7-2",
    question: "China's one-child policy, introduced in 1979, produced which unintended consequence?",
    options: [
      "A sharp increase in the country's total fertility rate",
      "A skewed sex ratio and a rapidly aging population",
      "An immediate and permanent labor surplus",
      "The complete elimination of rural-to-urban migration"
    ],
    correctIndex: 1,
    explanation: "Son preference combined with the limit produced millions of missing girls, and the small cohorts now leave few workers supporting many retirees. China relaxed the policy in 2015."
  },
  {
    id: "2-7-3",
  ...
  {
    id: "2-7-5",
    question: "The most consistently effective means of reducing fertility has proven to be",
    options: [
      "expanding girls' education and economic opportunity",
      "imposing legal penalties on families with many children",
      "restricting internal migration to large urban centers",
      "increasing the legal age at which people may marry"
    ],
    correctIndex: 0,
    explanation: "Educated women marry later, have fewer children, and space births, a pattern that holds across very different societies. It is both more effective and less coercive than legal limits."
  },
  {
    id: "2-7-6",
