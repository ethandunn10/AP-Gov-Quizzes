...
// Registered in quizzes-hug/index.js as "hug-topic-3-1".
...
window.QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      "evaluating other cultures by one's own as the standard",
      "the study of how cultural traits spread between regions",
      "the practice of adopting traits from neighboring cultures",
      "the geographic concentration of one ethnic group in a city"
    ],
    correctIndex: 0,
    explanation: "Ethnocentric judgments treat one's own practices as normal and others as deviations. Colonial administration and early geography were heavily shaped by it."
  },
  {
    id: "3-1-8",
    question: "Cultural identity is best understood as",
    options: [
      "a fixed characteristic determined entirely at birth",
      "something people construct and can hold at multiple scales",
      "a property assigned exclusively by national governments",
      "an attribute that never changes across a person's lifetime"
    ],
    correctIndex: 1,
    explanation: "A person may identify with a neighborhood, a region, a nation, and a diaspora simultaneously, and those identities shift over time. Geographers treat identity as produced rather than given."
  },
  {
    id: "3-1-9",
    question: "A taboo is",
