...
// Registered in quizzes-hug/index.js as "hug-topic-3-6".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "3-6-3",
    question: "Transnational corporations diffuse culture by",
    options: [
      "operating exclusively within their home country's borders",
      "refusing to adapt products to local markets anywhere",
      "distributing standardized products and brands globally",
      "preventing local businesses from adopting new practices"
    ],
    correctIndex: 2,
    explanation: "Global brands carry consumption norms and imagery along with their products. They also adapt offerings locally, which produces stimulus diffusion."
  },
  {
    id: "3-6-4",
    question: "Contemporary migration contributes to diffusion through",
    options: [
      "the complete cessation of cultural contact between regions",
      "the isolation of migrant communities from all outside contact",
      "the requirement that migrants abandon their culture entirely",
      "transnational communities linking origin and destination"
    ],
    correctIndex: 3,
    explanation: "Cheap travel and communication let migrants sustain active ties with home, so culture flows both ways. Remittances, media, and return visits maintain those connections."
  },
  {
    id: "3-6-5",
