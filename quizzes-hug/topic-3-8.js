...
// Registered in quizzes-hug/index.js as "hug-topic-3-8".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "3-8-5",
    question: "Diffusion affects religious landscapes by",
    options: [
      "introducing new places of worship into receiving areas",
      "requiring all religions to use identical architecture",
      "leaving the built environment entirely unchanged",
      "preventing any religious building from being constructed"
    ],
    correctIndex: 0,
    explanation: "Mosques in European cities and Buddhist temples in North America mark diffusion in the landscape. Disputes over their visibility often follow."
  },
  {
    id: "3-8-6",
