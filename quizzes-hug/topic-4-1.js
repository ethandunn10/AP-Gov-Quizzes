...
// Registered in quizzes-hug/index.js as "hug-topic-4-1".
// Topic 4.1 — Introduction to Political Geography

window.QUIZ_QUESTIONS = [
  {
    id: "4-1-1",
    question: "A state, in political geography, is defined as",
    options: [
      "an administrative subdivision within a larger country",
      "a region occupied by a single ethnic group",
      "defined borders, permanent population, and sovereignty",
      "any group of people sharing a common language and culture"
    ],
    correctIndex: 2,
    explanation: "Sovereignty and international recognition distinguish a state from other territorial units. The term differs from its American usage for subnational units."
  },
  {
    id: "4-1-2",
    question: "A nation is best defined as",
    options: [
      "an administrative district created by a central government",
      "the total population living within any political boundary",
      "a territory recognized as sovereign under international law",
      "a group sharing culture, history, and identity"
    ],
    correctIndex: 3,
    explanation: "Nations are cultural communities that may or may not possess a state of their own. The Kurds are a nation without a state."
  },
  {
    id: "4-1-3",
    question: "A nation-state is a political unit in which",
    options: [
      "the boundaries of a state closely match those of a nation",
      "a government rules territory it does not legally own",
      "several distinct nations share one sovereign territory",
      "a nation exists without any territory of its own"
    ],
    correctIndex: 0,
    explanation: "Iceland and Japan approximate the ideal, though few states are truly homogeneous. Most states contain multiple national groups."
  },
  {
    id: "4-1-4",
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation: "Sovereignty combines internal supremacy with external independence, and recognition by other states matters in practice. It is the defining attribute of statehood."
  },
  {
    id: "4-1-7",
