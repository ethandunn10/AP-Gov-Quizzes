...
// Registered in quizzes-hug/index.js as "hug-topic-4-10".
// Topic 4.10 — Consequences of Centrifugal and Centripetal Forces

window.QUIZ_QUESTIONS = [
  {
    id: "4-10-1",
    question: "Centripetal forces contribute to state stability by",
    options: [
      "building shared identity and loyalty to the state",
      "emphasizing differences among regional populations",
      "concentrating wealth in one region of the country",
      "weakening communication between distant regions"
    ],
    correctIndex: 0,
    explanation: "National language, symbols, schooling, and shared institutions bind populations together. Rallying against an external threat can produce the same effect temporarily."
  },
  {
    id: "4-10-2",
    question: "Which is the clearest example of a centripetal force?",
    options: [
      "Sharp economic inequality between two regions of a state",
      "A widely shared national language taught in public schools",
      "A territorially concentrated minority seeking independence",
      "Physical barriers separating a region from the national core"
    ],
    correctIndex: 1,
    explanation: "Common language enables communication and shared identity across a territory. The other options describe forces that pull a state apart."
  },
  {
    id: "4-10-3",
