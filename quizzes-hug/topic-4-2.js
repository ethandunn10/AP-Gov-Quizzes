...
// Registered in quizzes-hug/index.js as "hug-topic-4-2".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "4-2-2",
    question: "The Berlin Conference of 1884-1885 shaped African political geography by",
    options: [
      "granting independence to existing African kingdoms",
      "establishing an African union of sovereign states",
      "requiring European powers to withdraw from the continent",
      "setting rules for European partition, with no African voice"
    ],
    correctIndex: 3,
    explanation: "Borders drawn to suit European claims split ethnic groups and combined rivals. Those boundaries were largely inherited at independence and persist today."
  },
  {
    id: "4-2-3",
