...
// Registered in quizzes-hug/index.js as "hug-topic-4-4".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "4-4-3",
    question: "A subsequent boundary is one that",
    options: [
      "developed along with the cultural landscape it divides",
      "existed before any human settlement in the area",
      "has ceased to function as a political division",
      "was imposed by an outside power ignoring local divisions"
    ],
    correctIndex: 0,
    explanation: "Boundaries in Europe often evolved to reflect existing linguistic and ethnic divisions. They tend to be more stable than imposed boundaries."
  },
  {
    id: "4-4-4",
  ...
  {
    id: "4-4-9",
    question: "Maritime boundaries under the Law of the Sea grant states",
    options: [
      "unlimited rights over all ocean areas near their coastline",
      "no rights whatsoever beyond their land territory",
      "an exclusive economic zone extending 200 nautical miles",
      "authority to prohibit all foreign vessels from passing"
    ],
    correctIndex: 2,
    explanation: "UNCLOS grants a 12-mile territorial sea and a 200-mile EEZ for resource exploitation. Overlapping claims, as in the South China Sea, generate significant disputes."
  },
  {
    id: "4-4-10",
