...
// Registered in quizzes-hug/index.js as "hug-topic-4-5".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "4-5-3",
    question: "A boundary dispute over the exact position of a line is classified as",
    options: [
      "a functional dispute about how the boundary operates",
      "an allocational dispute about resources beneath it",
      "a definitional dispute about the legal wording",
      "a locational dispute about where the boundary lies"
    ],
    correctIndex: 3,
    explanation: "Locational disputes concern placement, often where original documents were vague or terrain has shifted. They are among the most common boundary conflicts."
  },
  {
    id: "4-5-4",
    ...
    correctIndex: 0,
    explanation: "Disagreements over border crossings, policing, and migration control fall into this category. They can arise even where the line itself is undisputed."
  },
  {
    id: "4-5-5",
  ...
  {
    id: "4-5-6",
    question: "Boundaries can serve as barriers or as connectors depending on",
    options: [
      "the physical terrain through which the boundary passes",
      "the total length of the boundary being considered",
      "policy decisions about movement, trade, and cooperation",
      "the age of the boundary and when it was first drawn"
    ],
    correctIndex: 2,
    explanation: "The Schengen area made internal borders nearly invisible while other boundaries are heavily fortified. The same line can function differently as policy changes."
  },
  {
    id: "4-5-7",
    question: "Border regions often develop distinctive characteristics because they",
    options: [
      "are always uninhabited due to security restrictions",
      "have identical economies on both sides of the line",
      "are legally exempt from both countries' national laws",
      "experience daily interaction and mixing across the line"
    ],
    correctIndex: 3,
    explanation: "Borderlands frequently develop bilingual populations, cross-border commuting, and hybrid cultures. The Mexico-United States borderland is a heavily studied example."
  },
  {
    id: "4-5-8",
