...
// Registered in quizzes-hug/index.js as "hug-topic-4-8".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "4-8-2",
    question: "Catalonia's independence movement is driven substantially by",
    options: [
      "a lack of any regional government institutions in Catalonia",
      "the absence of any distinct Catalan language or culture",
      "Catalonia's status as Spain's poorest and least developed region",
      "distinct language and identity plus a sense of fiscal unfairness"
    ],
    correctIndex: 3,
    explanation: "Catalans point to their language and history and argue they contribute more to Madrid than they receive. Catalonia is among Spain's wealthiest regions with substantial existing autonomy."
  },
  {
    id: "4-8-3",
  ...
  {
    id: "4-8-7",
    question: "The breakup of Yugoslavia demonstrated devolution that",
    options: [
      "escalated into violent conflict and state disintegration",
      "proceeded peacefully through negotiated referendums",
      "resulted in a stronger and more centralized federal state",
      "occurred without any ethnic or national dimension"
    ],
    correctIndex: 0,
    explanation: "Nationalist mobilization after Tito's death produced war, ethnic cleansing, and seven successor states. It is the standard contrast with peaceful devolution in Britain."
  },
  {
    id: "4-8-8",
