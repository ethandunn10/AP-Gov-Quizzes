...
// Registered in quizzes-hug/index.js as "hug-topic-4-9".
// Topic 4.9 — Challenges to Sovereignty

window.QUIZ_QUESTIONS = [
  {
    id: "4-9-1",
    question: "Supranational organizations challenge state sovereignty because members",
    options: [
      "must accept common rules and shared decision-making",
      "are required to dissolve their national governments",
      "lose all authority over their domestic legal systems",
      "gain complete freedom from international obligations"
    ],
    correctIndex: 0,
    explanation: "EU members accept the jurisdiction of shared institutions in exchange for market access and collective weight. National governments remain, but their discretion narrows."
  },
  {
    id: "4-9-2",
  ...
  {
    id: "4-9-7",
    question: "The internet and global communications challenge sovereignty by",
    options: [
      "making all information subject to national government approval",
      "eliminating every state's ability to regulate anything",
      "allowing information to cross borders beyond state control",
      "confining online activity strictly within national boundaries"
    ],
    correctIndex: 2,
    explanation: "States respond with firewalls and data localization laws, showing the contest is ongoing rather than settled. Control is reduced rather than eliminated."
  },
  {
    id: "4-9-8",
    question: "Failed or fragile states illustrate challenges to sovereignty because such states",
    options: [
      "exercise complete control over all their national territory",
      "have voluntarily transferred sovereignty to neighboring states",
      "have been formally dissolved by the United Nations",
      "cannot provide security or services across their territory"
    ],
    correctIndex: 3,
    explanation: "Somalia and parts of the Sahel retain legal recognition without effective control. The gap between formal and functional sovereignty is the analytical point."
  },
  {
    id: "4-9-9",
    question: "International courts such as the ICC affect sovereignty by",
    options: [
      "prosecuting individuals for crimes states will not address",
      "replacing all national court systems with a single body",
      "requiring every state to surrender its criminal jurisdiction",
      "having binding authority over states that have not joined"
    ],
    correctIndex: 0,
    explanation: "The court acts where national systems are unwilling or unable, which limits leaders' immunity. Its reach depends on state cooperation and several major powers remain outside."
  },
  {
    id: "4-9-10",
