...
// Registered in quizzes-hug/index.js as "hug-topic-5-10".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-10-2",
    question: "Soil salinization is a common consequence of",
    options: [
      "planting nitrogen fixing legumes in a rotation cycle",
      "irrigation in dry regions where water evaporates rapidly",
      "leaving fields fallow for a full growing season",
      "applying organic compost instead of chemical fertilizer"
    ],
    correctIndex: 1,
    explanation: "Irrigation water carries dissolved salts, and when it evaporates rather than draining, the salts accumulate until crops fail. The Aral Sea basin and parts of California's Central Valley show the effect clearly."
  },
  {
    id: "5-10-3",
  ...
  {
    id: "5-10-6",
    question: "Concentrated animal feeding operations raise environmental concern mainly because they",
    options: [
      "require unusually large areas of open grazing land",
      "generate concentrated waste that can contaminate water",
      "produce far less meat per animal than pasture systems",
      "depend entirely on forage the animals gather themselves"
    ],
    correctIndex: 1,
    explanation: "Thousands of animals in one place produce manure faster than surrounding land can absorb it, risking nitrate and pathogen contamination. Their defining trait is small land area with purchased feed, not extensive grazing."
  },
  {
    id: "5-10-7",
  ...
  {
    id: "5-10-10",
    question: "The Dust Bowl of the 1930s illustrates the consequences of",
    options: [
      "irrigating semiarid land with heavily mineralized water",
      "plowing grassland unsuited to sustained crop cultivation",
      "abandoning cultivated fields to natural prairie regrowth",
      "concentrating livestock in enclosed feeding operations"
    ],
    correctIndex: 1,
    explanation: "Breaking deep-rooted prairie sod on the southern Plains left soil exposed, and drought turned it to airborne dust. The episode reshaped American soil conservation policy."
  }
];
