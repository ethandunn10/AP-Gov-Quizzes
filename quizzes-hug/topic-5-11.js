...
// Registered in quizzes-hug/index.js as "hug-topic-5-11".
// Topic 5.11 — Challenges of Contemporary Agriculture

window.QUIZ_QUESTIONS = [
  {
    id: "5-11-1",
    question: "Genetically modified organisms in agriculture are crops whose",
    options: [
      "seed has been selected by hand over many generations",
      "genetic material has been altered by laboratory techniques",
      "yields have been raised through improved irrigation alone",
      "growth is managed without any application of pesticide"
    ],
    correctIndex: 1,
    explanation: "GMOs involve direct manipulation of DNA, typically for herbicide tolerance or pest resistance. Generations of selective breeding produce different results through a much slower conventional process."
  },
  {
    id: "5-11-2",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "These projects supply fresh produce in underserved neighborhoods and build community, but their scale cannot approach a city's full demand. Rural production remains essential."
  },
  {
    id: "5-11-5",
  ...
  {
    id: "5-11-7",
    question: "Women's role in agriculture in many developing regions is notable because women",
    options: [
      "perform most farm labor while holding little land title",
      "own the majority of agricultural land in those regions",
      "work almost exclusively in mechanized commercial farming",
      "are legally barred from participating in any farm work"
    ],
    correctIndex: 1,
    explanation: "Women supply a large share of food production labor yet face barriers to land ownership, credit, and extension services. Closing that gap is a recurring focus of development policy."
  },
  {
    id: "5-11-8",
    question: "Declining rural population in many developed countries has led to",
    options: [
      "expansion of services in small agricultural towns",
      "school and hospital closures as communities shrink",
      "a sharp increase in the number of working farms",
      "rising rural land prices in the most remote districts"
    ],
    correctIndex: 1,
    explanation: "Depopulation removes the customer base that sustains institutions, producing a self-reinforcing cycle of decline. Farm numbers have fallen even as average farm size has grown."
  },
  {
    id: "5-11-9",
