...
// Registered in quizzes-hug/index.js as "hug-topic-5-12".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-12-2",
    question: "The gender division of labor in subsistence agriculture often assigns women",
    options: [
      "operation of heavy mechanized harvesting equipment",
      "planting, weeding, processing, and water collection",
      "negotiation of export contracts with foreign buyers",
      "management of large commercial livestock ranches"
    ],
    correctIndex: 1,
    explanation: "Tasks that are labor-intensive, repetitive, and close to the household tend to fall to women, along with food preparation and fuel and water gathering. Mechanized and commercial roles are more often male-dominated."
  },
  {
    id: "5-12-3",
  ...
  {
    id: "5-12-6",
    question: "Male out-migration from rural areas often results in",
    options: [
      "a reduced workload for the women who remain behind",
      "feminization of agriculture as women take on more tasks",
      "the complete abandonment of farming in those villages",
      "immediate transfer of land titles to women household heads"
    ],
    correctIndex: 1,
    explanation: "When men leave for urban or overseas work, women absorb the farm tasks while retaining household responsibilities. Formal land rights rarely follow that shift in actual responsibility."
  },
  {
    id: "5-12-7",
  ...
  {
    id: "5-12-10",
    question: "Improving women's status in agriculture is considered a development priority because it",
    options: [
      "shifts subsistence farming toward export crop production",
      "raises household nutrition, income, and children's schooling",
      "reduces the number of people working in the farm sector",
      "eliminates the need for any agricultural extension programs"
    ],
    correctIndex: 1,
    explanation: "Income controlled by women is disproportionately spent on food, health, and education, so gains propagate through the household. This multiplier effect is why gender equity is treated as a development lever rather than only a rights question."
  }
];
