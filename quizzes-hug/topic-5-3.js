...
// Registered in quizzes-hug/index.js as "hug-topic-5-3".
// Topic 5.3 — Agricultural Origins and Diffusions

window.QUIZ_QUESTIONS = [
  {
    id: "5-3-1",
    question: "The First Agricultural Revolution refers to the",
    options: [
      "domestication of plants and animals by early peoples",
      "breeding of high yield grain varieties for poor nations",
      "enclosure of open fields into privately held parcels",
      "mechanization of farm labor using powered equipment"
    ],
    correctIndex: 0,
    explanation: "The Neolithic Revolution was the shift from foraging to deliberate cultivation and herding roughly 10,000 years ago. Mechanization and high yield breeding name the Second Agricultural Revolution and the Green Revolution respectively."
  },
  {
    id: "5-3-2",
  ...
  {
    id: "5-3-4",
    question: "Which crop and hearth pairing is correct?",
    options: [
      "Maize was first domesticated in the Indus River valley",
      "Maize was first domesticated in West African savanna",
      "Maize was first domesticated in the Nile River valley",
      "Maize was first domesticated in Mesoamerica"
    ],
    correctIndex: 3,
    explanation: "Maize descends from teosinte, a wild grass of southern Mexico, and spread north and south from there. It reached Africa and Asia only after 1492 through the Columbian Exchange."
  },
  {
    id: "5-3-5",
  ...
  {
    id: "5-3-8",
    question: "Vegetative planting differs from seed agriculture in that it reproduces plants from",
    options: [
      "grafts joining two genetically unrelated crop species",
      "spores collected and stored between growing seasons",
      "seeds gathered from the strongest plants each harvest",
      "cuttings, roots, or other parts of an existing plant"
    ],
    correctIndex: 3,
    explanation: "Vegetative planting clones a parent plant from a piece of it, as with cassava or taro, and is likely the older of the two methods. Seed agriculture, by contrast, relies on sexual reproduction through saved seed."
  },
  {
    id: "5-3-9",
    question: "Geographers studying agricultural hearths rely heavily on evidence from",
    options: [
      "archaeology, genetics, and the ranges of wild relatives",
      "survey maps recording modern property boundary lines",
      "interviews conducted with present-day commercial farmers",
      "current national statistics on total crop production"
    ],
    correctIndex: 0,
    explanation: "Seed remains, genetic comparison with wild ancestors, and the distribution of those wild relatives all point to where domestication happened. Modern production or property data reflect recent economics, not ancient origins."
  },
  {
    id: "5-3-10",
