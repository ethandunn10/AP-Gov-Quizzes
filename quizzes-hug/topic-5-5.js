...
// Registered in quizzes-hug/index.js as "hug-topic-5-5".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-5-2",
    question: "Norman Borlaug is most closely associated with developing",
    options: [
      "irrigation canal systems for the arid Middle East",
      "high yield dwarf wheat varieties resistant to disease",
      "the first commercially available genetically modified corn",
      "crop rotation schedules used across eighteenth century Europe"
    ],
    correctIndex: 1,
    explanation: "Borlaug's short-stemmed wheat carried heavy grain heads without falling over, and its adoption in Mexico and South Asia averted predicted famines. Genetic modification in the laboratory sense came decades later."
  },
  {
    id: "5-5-3",
  ...
  {
    id: "5-5-6",
    question: "An environmental consequence associated with Green Revolution practices is",
    options: [
      "a measurable increase in the diversity of planted crops",
      "groundwater depletion and runoff from applied chemicals",
      "the natural restoration of soil nutrients without inputs",
      "a decline in the total acreage under active irrigation"
    ],
    correctIndex: 1,
    explanation: "Intensive irrigation drew down aquifers while nitrogen fertilizer and pesticides washed into waterways. Monoculture planting of a few high yield varieties reduced crop diversity rather than increasing it."
  },
  {
    id: "5-5-7",
  ...
  {
    id: "5-5-10",
    question: "Which statement best evaluates the Green Revolution's overall record?",
    options: [
      "It failed to raise yields anywhere it was actually adopted",
      "It raised food output substantially but at social and ecological cost",
      "It solved world hunger permanently in every adopting nation",
      "It affected only research institutions and not working farms"
    ],
    correctIndex: 1,
    explanation: "The yield gains were real and prevented mass famine in South Asia, while inequality, chemical dependence, and water depletion followed. A balanced judgment holds both halves together."
  }
];
