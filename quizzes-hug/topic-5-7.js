...
// Registered in quizzes-hug/index.js as "hug-topic-5-7".
// Topic 5.7 — Spatial Organization of Agriculture

window.QUIZ_QUESTIONS = [
  {
    id: "5-7-1",
    question: "Agribusiness refers to the system in which",
    options: [
      "farms operate independently of processors and retailers",
      "farming is integrated with supply, processing, and sales",
      "governments own and directly manage all farmland",
      "households grow food solely for their own consumption"
    ],
    correctIndex: 1,
    explanation: "Agribusiness treats agriculture as one link in a commercial chain running from seed and chemical suppliers through processing to the grocery shelf. Independent farming is exactly what this integration displaces."
  },
  {
    id: "5-7-2",
  ...
  {
    id: "5-7-5",
    question: "Contract farming typically requires a grower to",
    options: [
      "sell the harvest to whichever buyer offers the best price",
      "produce a set quantity and quality for a specific buyer",
      "purchase the processing facility handling the output",
      "rotate among several unrelated crops each growing season"
    ],
    correctIndex: 1,
    explanation: "The contract fixes volume, specifications, and often the inputs used, giving the farmer price certainty while transferring control to the buyer. Open-market selling is what the arrangement replaces."
  },
  {
    id: "5-7-6",
    question: "The global food distribution system depends most heavily on",
    options: [
      "local markets located within walking distance of farms",
      "refrigerated transport and containerized shipping networks",
      "seasonal restrictions preventing any long distance trade",
      "barter arrangements negotiated between neighboring states"
    ],
    correctIndex: 1,
    explanation: "Cold chains and container logistics let perishable goods cross oceans, so consumers eat strawberries in winter. This infrastructure is what makes a genuinely global food system possible."
  },
  {
    id: "5-7-7",
  ...
  {
    id: "5-7-8",
    question: "Government subsidies affect agricultural geography by",
    options: [
      "eliminating all variation in what farmers choose to plant",
      "encouraging production of crops beyond market demand",
      "lowering the total acreage under cultivation everywhere",
      "preventing any agricultural exports from leaving a country"
    ],
    correctIndex: 1,
    explanation: "Guaranteed payments make a supported crop attractive even when prices would not justify it, producing surpluses and shaping land use. Subsidized surpluses are frequently exported, sometimes undercutting farmers elsewhere."
  },
  {
    id: "5-7-9",
