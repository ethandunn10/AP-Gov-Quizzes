...
// Registered in quizzes-hug/index.js as "hug-topic-5-9".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "5-9-2",
    question: "Export commodity dependence makes a national economy vulnerable because",
    options: [
      "domestic consumers refuse to purchase the exported crop",
      "world price swings for one crop destabilize total revenue",
      "the crop cannot physically be shipped to distant markets",
      "international law caps the quantity that may be exported"
    ],
    correctIndex: 1,
    explanation: "When most foreign earnings come from a single commodity, a bad price year hits the whole economy. Diversification is the standard prescription for exactly this reason."
  },
  {
    id: "5-9-3",
  ...
  {
    id: "5-9-6",
    question: "Food security is best defined as",
    options: [
      "producing enough food within a country's own borders",
      "reliable access to sufficient safe and nutritious food",
      "maintaining stockpiles of grain for emergency use only",
      "preventing any imported food from entering a country"
    ],
    correctIndex: 1,
    explanation: "Security is about access, not self-sufficiency: a country can import most of its food and remain secure if supply and income are dependable. Conversely, domestic abundance does not guarantee everyone can afford it."
  },
  {
    id: "5-9-7",
  ...
  {
    id: "5-9-10",
    question: "Which development has most increased the distance food travels to consumers?",
    options: [
      "Rising consumer preference for locally grown produce",
      "Containerized shipping paired with air freight and cold chains",
      "Growth in the number of small diversified family farms",
      "Increased government restriction on agricultural imports"
    ],
    correctIndex: 1,
    explanation: "Cheap bulk shipping and refrigeration made year-round global sourcing routine, sharply raising food miles. The other options would each shorten supply chains rather than lengthen them."
  }
];
