...
// Registered in quizzes-hug/index.js as "hug-topic-6-10".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-10-2",
    question: "Redlining refers to the historic practice of",
    options: [
      "drawing new municipal boundaries to annex suburban land",
      "denying mortgages and insurance in minority neighborhoods",
      "designating industrial zones near residential districts",
      "marking historic buildings for preservation from demolition"
    ],
    correctIndex: 1,
    explanation: "Federal appraisal maps graded minority areas as too risky for lending, starving them of capital for decades. The resulting disinvestment still shapes wealth and housing patterns today."
  },
  {
    id: "6-10-3",
  ...
  {
    id: "6-10-6",
    question: "Suburban sprawl imposes fiscal costs on local government chiefly because",
    options: [
      "dense development requires more infrastructure per resident",
      "spread out development costs more to serve per household",
      "suburban residents pay substantially higher property taxes",
      "outlying areas require no roads, sewers, or emergency service"
    ],
    correctIndex: 1,
    explanation: "Longer pipe runs, more road miles, and greater response distances raise the per-household cost of services. Density lowers that cost, which is the opposite of the first option."
  },
  {
    id: "6-10-7",
  ...
  {
    id: "6-10-10",
    question: "Which response to gentrification is most directly aimed at preventing displacement?",
    options: [
      "Accelerating luxury housing construction in the neighborhood",
      "Inclusionary zoning and community land trust programs",
      "Removing rent regulations from existing apartment units",
      "Reducing public transit service to the affected district"
    ],
    correctIndex: 1,
    explanation: "Inclusionary requirements and land trusts lock in permanently affordable units as values rise. Policies that treat supply alone as the answer do not by themselves protect current residents."
  }
];
