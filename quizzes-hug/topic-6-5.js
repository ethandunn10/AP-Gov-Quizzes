...
// Registered in quizzes-hug/index.js as "hug-topic-6-5".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-5-4",
    question: "The Harris and Ullman multiple nuclei model argues that cities develop around",
    options: [
      "a single dominant center controlling all activity",
      "several separate centers with distinct specialized functions",
      "concentric rings of steadily improving housing quality",
      "wedges determined by the direction of prevailing winds"
    ],
    correctIndex: 1,
    explanation: "Airports, universities, ports, and industrial parks each anchor their own node, and incompatible uses repel one another. The model fits automobile-era cities better than the earlier two."
  },
  {
    id: "6-5-5",
  ...
  {
    id: "6-5-8",
    question: "The McGee model of the Southeast Asian city is organized around",
    options: [
      "a strong central business district at the geographic center",
      "a colonial port zone with commercial functions dispersed nearby",
      "concentric zones matching the Burgess model exactly",
      "industrial suburbs located far inland from the coast"
    ],
    correctIndex: 1,
    explanation: "The export-oriented port anchors the city, with an alien commercial zone, a Western commercial zone, and a mixed zone alongside it. No single unified CBD dominates."
  },
  {
    id: "6-5-9",
