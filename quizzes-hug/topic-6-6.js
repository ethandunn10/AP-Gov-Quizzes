...
// Registered in quizzes-hug/index.js as "hug-topic-6-6".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-6-2",
    question: "Zoning ordinances are used by local governments primarily to",
    options: [
      "set the purchase price of land within city limits",
      "regulate what activities may occur on a given parcel",
      "determine which residents may vote in local elections",
      "assign students to particular neighborhood schools"
    ],
    correctIndex: 1,
    explanation: "Zoning separates incompatible uses and controls density, height, and setbacks. It shapes land prices indirectly but does not set them."
  },
  {
    id: "6-6-3",
  ...
  {
    id: "6-6-6",
    question: "New urbanism as a planning movement emphasizes",
    options: [
      "low density development served primarily by highways",
      "walkable neighborhoods with mixed uses and transit access",
      "strict separation of housing from all commercial activity",
      "the demolition of historic buildings to raise densities"
    ],
    correctIndex: 1,
    explanation: "New urbanism revives prewar design principles, favoring grids, front porches, and short blocks over cul-de-sacs. Critics note that its developments can still be expensive and car-dependent in practice."
  },
  {
    id: "6-6-7",
  ...
  {
    id: "6-6-10",
    question: "Residential density restrictions such as single family zoning have been criticized for",
    options: [
      "increasing the total supply of affordable urban housing",
      "limiting housing supply and raising costs in desirable areas",
      "encouraging excessive high rise construction downtown",
      "reducing the average commuting distance for workers"
    ],
    correctIndex: 1,
    explanation: "Reserving most residential land for detached houses caps how many units can be built where demand is highest. Several cities have recently legalized duplexes and accessory units in response."
  }
];
