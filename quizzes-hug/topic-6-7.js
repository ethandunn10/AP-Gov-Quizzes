...
// Registered in quizzes-hug/index.js as "hug-topic-6-7".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-7-4",
    question: "Deferred maintenance of infrastructure in older cities has most often resulted from",
    options: [
      "rapid growth overwhelming newly built utility systems",
      "shrinking tax bases as population and industry left",
      "national policies requiring the removal of old systems",
      "a lack of engineering knowledge about needed repairs"
    ],
    correctIndex: 1,
    explanation: "When residents and firms leave, revenue falls while aging pipes and bridges still require upkeep. Flint's water crisis and similar failures trace to this fiscal squeeze."
  },
  {
    id: "6-7-5",
  ...
  {
    id: "6-7-8",
    question: "A city's infrastructure decisions have long term consequences largely because such systems",
    options: [
      "can be relocated inexpensively whenever needs change",
      "are costly and durable, locking in patterns for decades",
      "have no measurable effect on where people choose to live",
      "are replaced completely every ten to fifteen years"
    ],
    correctIndex: 1,
    explanation: "A subway line or a highway shapes land values and travel behavior for generations after it is built. This path dependence makes early choices unusually consequential."
  },
  {
    id: "6-7-9",
