...
// Registered in quizzes-hug/index.js as "hug-topic-6-9".
...
window.QUIZ_QUESTIONS = [
  ...
  {
    id: "6-9-4",
    question: "A geographic information system allows analysts to",
    options: [
      "collect census responses directly from every household",
      "layer and analyze spatial data to reveal patterns",
      "predict population totals without any collected data",
      "replace fieldwork entirely in every urban study"
    ],
    correctIndex: 1,
    explanation: "Overlaying income, transit access, and pollution layers can expose relationships invisible in tables. GIS analyzes data that still must be gathered by other means."
  },
  {
    id: "6-9-5",
  ...
  {
    id: "6-9-8",
    question: "A key limitation of census data in rapidly growing developing world cities is that it",
    options: [
      "is collected far too frequently to reveal any trends",
      "often undercounts residents of informal settlements",
      "covers only the wealthiest districts of each city",
      "measures land area rather than resident population"
    ],
    correctIndex: 1,
    explanation: "Households without legal addresses or with reason to avoid officials are systematically missed. Undercounting then reduces the services and representation those areas receive."
  },
  {
    id: "6-9-9",
