...
window.QUIZ_QUESTIONS = [
  {
    ...
    options: [
      "A sample selected so that every member of the target population has an equal chance of being chosen",
  ...
  },
  {
    ...
    options: [
      "The range within which the true population value is likely to fall, given sampling variability",
  ...
  },
  {
    ...
    options: [
      "A smaller margin of error, making the poll's results more statistically precise",
  ...
  },
  {
    ...
    options: [
      "A poll disguised as research but really designed to spread negative information about a candidate",
  ...
  },
  {
    ...
    options: [
      "Subtle phrasing differences can lead respondents to different answers on the same issue",
  ...
  },
  {
    ...
    options: [
      "Sampling bias, which can make the results unreliable as a measure of public opinion",
  ...
  },
  {
    ...
    options: [
      "Respondents don't answer truthfully, perhaps due to social desirability on a sensitive question",
  ...
  },
  {
    ...
    options: [
      "Online opt-in polls, where respondents self-select rather than being randomly chosen",
  ...
  },
  {
    ...
    options: [
      "Uses loaded, leading language that pushes respondents toward a particular answer",
