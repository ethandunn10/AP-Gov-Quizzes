...
window.QUIZ_QUESTIONS = [
  {
    ...
    options: [
      ...
      "A direct national popular vote alone",
      "Congress voting directly",
      "State governors",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "Winner-take-all -- whichever candidate wins the statewide popular vote gets all of that state's electoral votes",
  ...
  },
  {
    ...
    options: [
      "The Electoral College is based on state-by-state results, so a candidate can win enough closely contested large states to reach 270 electoral votes without winning the most total votes nationwide",
      "This has never actually happened in U.S. history",
      "The popular vote is not counted in presidential elections",
      "Only registered electors are allowed to vote",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "Select delegates who will formally nominate the party's presidential candidate at the national convention",
      "Directly elect the President",
      "Confirm Cabinet nominees",
      "Ratify treaties",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "\"Swing states\" -- competitive states where the outcome isn't a foregone conclusion",
      "States that always vote for the same party",
      "States with the smallest populations only",
      "Only the candidate's home state",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "Votes for a candidate other than the one they were pledged to support based on their state's popular vote result",
      "Refuses to vote at all",
      "Is legally required to switch votes every election",
      "Represents a foreign country",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "Can produce a result that doesn't match the national popular vote, and gives disproportionate influence to voters in smaller, closely contested states",
      "Perfectly reflects the national popular vote every single time",
      "Has no effect on how campaigns are run",
      "Gives every voter in every state exactly equal influence",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      "Requires candidates to build broad, geographically diverse coalitions of support rather than focusing only on the largest population centers",
      "Guarantees the popular vote winner always wins",
      "Is easier to change than a constitutional amendment",
      "Eliminates the need for any campaign strategy",
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "A simple congressional majority vote",
